            ...
            <tr>
                <td bgcolor="#ff6600">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding:2px">
                        <tr>
                            <td style="width:18px;padding-right:4px"><a href="index.html"><img src="y18.gif" width="18"
                                                                                               height="18"
                                                                                               style="border:1px white solid;"></a>
                            </td>
                            <td style="line-height:12pt; height:10px;"><span class="pagetop"><b class="hnname"><a
                                            href="news.html">Hacker News</a></b>
              <a href="newest.html">new</a> | <a href="front.html">past</a> | <a href="newcomments.html">comments</a> | <a
                                        href="ask.html">ask</a> | <a href="show.html">show</a> | <a href="jobs.html">jobs</a> | <a
                                        href="submit.html">submit</a>            </span></td>
                ...
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" class="itemlist">
                        @foreach($stories as $story)
                            ...
                            <td align="right" valign="top" class="title"><span class="rank">{{$story->id}}</span></td>
...
{{--                                            class="sitestr">locusmag.com</span></a>)</span>--}}
                            ...
                            <tr>
                                <td colspan="2"></td><td class="subtext">
                                    ...
                                    | <a href="item64b1.html?id={{$story->itemId}}">{{count(collect($story->kids))}}&nbsp;comments</a>
                                </td>
                            </tr>
                        @endforeach
